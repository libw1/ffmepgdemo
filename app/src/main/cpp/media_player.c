...
JNIEXPORT jint JNICALL Java_conykais_ffmepgdemo_MediaPlayer_setup
...
JNIEXPORT jint JNICALL Java_conykais_ffmepgdemo_MediaPlayer_play
...
JNIEXPORT void JNICALL Java_conykais_ffmepgdemo_MediaPlayer_release
        (JNIEnv * env, jclass clazz){
    //释放内存以及关闭文件
